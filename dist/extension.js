    ...
    create(data, type) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loading = (text, stop = false) => __awaiter(this, void 0, void 0, function* () {
                _loading = _loading !== null && _loading !== void 0 ? _loading : (yield (0, util_1.createLoading)(data.title));
...
var pidtree = __webpack_require__(8);
...
function get(callback) {
  ...
  var list = __webpack_require__(10)("./" + file);
  list(callback);
}
...
module.exports = __webpack_require__(16).YAML
...
var parseCst = __webpack_require__(17);
var Document$1 = __webpack_require__(19);
var Schema = __webpack_require__(21);
var PlainValue = __webpack_require__(18);
var warnings = __webpack_require__(22);
...
var PlainValue = __webpack_require__(18);
var resolveSeq = __webpack_require__(20);
var Schema = __webpack_require__(21);
...
class NestTreeProvider {
    constructor() {
        ...
        this.getChildren = (element) => !element ? this.treeList : element.children;
    }
    static get instance() {
        var _a;
